...
CREATE TABLE IF NOT EXISTS `province` (
    ...
    `name` VARCHAR(255) NOT NULL COMMENT '省份',
    PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 10000 DEFAULT CHARSET = utf8mb4 COMMENT = '省份数据表';
...
CREATE TABLE IF NOT EXISTS `city` (
    `id` INT(11) NOT NULL COMMENT '主键',
    `name` VARCHAR(255) NOT NULL COMMENT '地级市',
    `province_id` INT(11) NOT NULL COMMENT '省份编码',
    PRIMARY KEY (`id`) USING BTREE,
    INDEX `idx_province_id` (`province_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 10000 DEFAULT CHARSET = utf8mb4 COMMENT = '地级市数据表';
...
CREATE TABLE IF NOT EXISTS `area` (
    `id` INT(11) NOT NULL COMMENT '主键',
    `name` VARCHAR(255) NOT NULL COMMENT '县/区',
    `province_id` INT(11) NOT NULL COMMENT '省份id',
    `city_id` INT(11) NOT NULL COMMENT '地级市id',
    PRIMARY KEY (`id`) USING BTREE,
    INDEX `idx_province_id` (`province_id`) USING BTREE,
    INDEX `idx_city_id` (`city_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 10000 DEFAULT CHARSET = utf8mb4 COMMENT = '县区数据表';
...
) ENGINE = InnoDB AUTO_INCREMENT = 10000 DEFAULT CHARSET = utf8mb4 COMMENT = '街道数据表';
CREATE TABLE IF NOT EXISTS `village` (
    `id` INT(11) NOT NULL COMMENT '主键',
    `name` VARCHAR(255) NOT NULL COMMENT '村委会/居委会',
    `province_id` INT(11) NOT NULL COMMENT '省份id',
    `city_id` INT(11) NOT NULL COMMENT '地级市id',
    `area_id` INT(11) NOT NULL COMMENT '县区id',
    ...
    INDEX `idx_city_id` (`city_id`) USING BTREE,
    INDEX `idx_area_id` (`area_id`) USING BTREE,
    INDEX `idx_street_id` (`street_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 10000 DEFAULT CHARSET = utf8mb4 COMMENT = '村委会/居委会数据表';
-- +goose Down
